...
def L_model_backward(AL, Y, caches, lambd, parameters, keep_prob):
    """
...
def L_layer_model(X, Y, layers_dims, learning_rate=0.0075, num_iterations=3000, lambd=0.7, keep_prob=0.7, print_cost=False):  # lr was 0.009
    """
    ...
    for i in range(0, num_iterations):
        ...
        # Compute cost with L2 regulation.
        cost = compute_cost(AL, Y, lambd, parameters)
        # Backward propagation with L2 regulation.
        grads = L_model_backward(AL, Y, caches, lambd, parameters, keep_prob)
        # Update parameters.
